...
for epoch in pbar:
    ...
    pbar.set_description("loss=%.4f  acc=%.4f  roc=%.4f  ap=%.4f" % (
        avg_cost, avg_accuracy, val_roc_score[-1], ap_curr))

roc_score, ap_score = get_roc_score(test_edges, test_edges_false)
print "Test ROC score: %s" % roc_score
print "Test AP score: %s" % ap_score
