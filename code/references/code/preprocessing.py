...
def mask_test_edges(adj, all_edge_idx=None):
    ...
    print ('Edges: ' + str(edges.shape[0]))

    edges_all = sparse_to_tuple(adj)[0]
    num_test = int(np.floor(edges.shape[0] / 98.)) # 10 10%
    num_val = int(np.floor(edges.shape[0] / 98.)) # 20 5%
